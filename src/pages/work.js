	...
	return <Theme theme={theme}>
			...
			<Stack>
				...
				<StackItem width="100%" display="flex">
					<Override
						...
						sm-height="180px"
						md-height="360px"
						background="linear-gradient(100deg,rgba(57, 12, 150, 0.63) 20%,rgba(0,0,0,0) 100%) 0 0 no-repeat,#191C23 url(https://images.unsplash.com/photo-1579546928937-641f7ac9bced?ixlib=rb-1.2.1&q=85&fm=jpg&crop=entropy&cs=srgb&ixid=eyJhcHBfaWQiOjE0MjIzN30&h=2000) center center/cover repeat scroll padding-box"
					/>
					{"        "}
					<Text
						font="--headline1"
		...
		<Section padding="100px 0 80px 0" lg-padding="60px 0 60px 0" quarkly-title="Info" justify-content="center">
			...
			<Stack justify-content="space-between">
				...
				{"    "}
				<Components.Img>
					<Override slot="box" hover-background="linear-gradient(180deg,rgba(57, 12, 150, 0.63) 0%,rgba(0,0,0,0) 100%) 0 0 no-repeat,#191C23 url(https://images.unsplash.com/photo-1579546928937-641f7ac9bced?ixlib=rb-1.2.1&q=85&fm=jpg&crop=entropy&cs=srgb&ixid=eyJhcHBfaWQiOjE0MjIzN30&h=2000) center center/cover repeat scroll padding-box" />
				</Components.Img>
			</Stack>
		</Section>
		<Components.Usp1 />
