			...
			<Stack justify-content="space-between">
				...
				>
					...
					<Text
						...
						md-font="--base"
					>
						Первый вопрос, который возникает перед исследователями нервной системы и когнитивных процессов, - что такое память?

 Что такое память в биологическом аспекте? Как проявляется память на уровне отдельного нейрона? И в какой форме хранится информация в нервной системе?{"\n\n"}
					</Text>
					<Link
