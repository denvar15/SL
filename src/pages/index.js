		...
		>
			...
			<Stack>
				...
				>
					...
					<Box
						width="100%"
						background="#191C23 url(https://uploads.quarkly.io/5fa7b2b92c4ef2001e31e59d/images/khto_my.png?v=2021-01-06T15:20:46.801Z) center center/cover repeat scroll padding-box"
						margin="0px 0px 0px 0px"
						padding="0px 0px 60% 0px"
						height="0px"
						hover-background="#191C23 url(https://uploads.quarkly.io/5fa7b2b92c4ef2001e31e59d/images/khto_my.png?v=2021-01-06T15:20:46.801Z) center center/cover repeat scroll padding-box"
			...
			<Stack margin="80px -16px -16px -16px" lg-margin="50px -16px -16px -16px" md-margin="30px -16px -16px -16px">
				...
				>
					...
					<Box
						width="100%"
						background="#191C23 url(https://uploads.quarkly.io/5fa7b2b92c4ef2001e31e59d/images/why.png?v=2021-01-06T15:21:51.537Z) center center/cover repeat scroll padding-box"
						margin="0px 0px 0px 0px"
						padding="0px 0px 60% 0px"
						height="0px"
						hover-background="#191C23 url(https://uploads.quarkly.io/5fa7b2b92c4ef2001e31e59d/images/why.png?v=2021-01-06T15:21:51.537Z) center center/cover repeat scroll padding-box"
						transition="background --transitionDuration-normal --transitionTimingFunction-easeInOut 0s"
					/>
					{"    "}
				</StackItem>
			...
			<Stack margin="80px -16px -16px -16px" lg-margin="50px -16px -16px -16px" md-margin="30px -16px -16px -16px">
				...
				>
					...
					<Box
						width="100%"
						background="#191C23 url(https://uploads.quarkly.io/5fa7b2b92c4ef2001e31e59d/images/kak_my_rabotaem.png?v=2021-01-06T15:22:31.917Z) center center/cover repeat scroll padding-box"
						margin="0px 0px 0px 0px"
						padding="0px 0px 60% 0px"
						height="0px"
						hover-background="#191C23 url(https://uploads.quarkly.io/5fa7b2b92c4ef2001e31e59d/images/kak_my_rabotaem.png?v=2021-01-06T15:22:31.917Z) center center/cover repeat scroll padding-box"
						transition="background --transitionDuration-normal --transitionTimingFunction-easeInOut 0s"
					/>
					{"    "}
				</StackItem>
